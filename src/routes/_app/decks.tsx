...
function DecksComponent() {
  ...
  const handleEditDeck = (id: string) =>
    setDeckModal({ type: "editDeck", deckId: id });
  const handleDeleteDeck = (id: string) =>
    setDeckModal({ type: "deleteDeck", deckId: id });

  const editDeck =
    deckModal?.type === "editDeck" ? deckMap.get(deckModal.deckId) : undefined;
